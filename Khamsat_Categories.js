...
(function() {
    ...
    const categories = {
        ...
        كتابة: {
            keywords: ['كتابة', 'لكتابة', 'لكتابه', 'ترجمة', 'ترجمه', 'محتوى', 'مقالات','كتيب','مجلة','تفريغ', 'كاتب', 'تأليف', 'مدونة', 
        ...
        تعليم: {
            keywords: ['تعليم', 'الواجب', 'تدريب', 'تعليمية', 'دروس', 'مدرس', 'حل واجبات', 'كورس', 'معلم',
