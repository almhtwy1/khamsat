    ...
    (function () {
      let D = 300,
        ...
        cats = {
          ...
          تسويق: { k: ['تسويق','تسويقي','تسويقية','اعلان','اعلانات','حملات','ads','seo','marketing','فيسبوك','انستقرام','سناب','التسويق','الإعلانية','للتسويق','ادارة حسابات','براند','مبيعات','ترويج','جوجل أدز','ادسنس','حملات ممولة','cpa','bing','استراتيجية','guest post','تسويق عقاري','سوشيال ميديا','تيك توك'], i: 'fa-bullhorn', c: '#ffc107' },
          ...
          فيديو: { k: ['فيديو','موشن','مونتاج','انيميشن','الفيديو','الفيديوهات','فيديوهات','فديوهات','انترو','تحريك','animation','edit','اخراج','مونتير','تعديل ألوان','Video','فلاتر','ترانزيشن','إخراج سينمائي','تحرير فيديو','إعلان مصوَّر','Videographer'], i: 'fa-video', c: '#dc3545' },
    ...
    (function() {
      ...
      const createPriceCard = () => {
        ...
        function extractPrice(text) {
            const pricePattern = /(\d{1,5})[\s,]*(?:دولار|دولاراً|\$|USD|dollar)/gi;
            return [...text.matchAll(pricePattern)]
        ...
        function updatePrice(elements) {
            ...
            comments.forEach(comment => {
                ...
                if (content) {
                    allPrices.push(...extractPrice(content));
                }
            });
